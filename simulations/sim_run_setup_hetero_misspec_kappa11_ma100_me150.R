...
# kappa_vec <- kappa_
# kappa_vec <- kappa_val
kappa_vec <- 1.1 # misspecification of kappa (1.1 instead of 1.5)
...
# Save results
setup_desc <- paste0("pi_hetero_truekappa", kappa_,
                     "_usedkappa", kappa_vec,
                     "_ma", m_a,"_m_e",m_e, "_niter", n_iter,".csv")
